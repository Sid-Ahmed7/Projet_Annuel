...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse> forgotPassword(@Valid @RequestBody ForgotPasswordRequest request) {
        ...
        return ResponseEntity.ok(new ApiResponse(messageSource.getMessage("success.auth.password_reset_sent", null, LocaleUtils.getCurrentLocale())));
    }

    @PostMapping("/reset-password")
    public ResponseEntity<ApiResponse> resetPassword(@Valid @RequestBody ResetPasswordRequest request) {
        authService.resetPassword(request);
        return ResponseEntity.ok(new ApiResponse(messageSource.getMessage("success.auth.password_reset_success", null, LocaleUtils.getCurrentLocale())));
    }
    ...
    public ResponseEntity<ApiResponse> logout(HttpServletRequest request,HttpServletResponse response) {
        ...
        return ResponseEntity.ok(new ApiResponse(messageSource.getMessage("success.auth.logout", null, LocaleUtils.getCurrentLocale())));
    }
