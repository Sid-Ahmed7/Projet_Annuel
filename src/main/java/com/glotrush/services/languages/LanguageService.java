...
public class LanguageService implements ILanguageService {
    ...
    private LanguageResponse getLanguageDetails(Language language) {
        ...
        List<Topic> topics = topicRepository.findByTargetLanguage_IdAndIsActiveTrueOrderByDifficultyAscNameAsc(language.getId());
        ...
        int lessonsCount = lessonRepository.countByTopic_TargetLanguage_IdAndIsActiveTrueAndTopic_IsActiveTrue(language.getId());
